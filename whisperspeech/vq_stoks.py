# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/2A. VQ semantic token extraction model.ipynb.

# %% auto 0
__all__ = ['RQBottleneckTransformer', 'make_model']

# %% ../nbs/2A. VQ semantic token extraction model.ipynb 2
import io
import sys
import time
import torch
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 3
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 9
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 10
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 17
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 20
def load_datasets(
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 25
from whisperspeech.train import *
from whisperspeech.modules import *

# %% ../nbs/2A. VQ semantic token extraction model.ipynb 26
import dataclasses
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 27
import math

# %% ../nbs/2A. VQ semantic token extraction model.ipynb 28
...
# %% ../nbs/2A. VQ semantic token extraction model.ipynb 30
