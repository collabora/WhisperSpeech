...
# %% auto 0
__all__ = ['load_datasets', 'rand', 'Tunables', 'Encoder', 'T2SEmbeddingWithPositional', 'Decoder', 'TSARTransformer',
           'make_model']
...
# %% ../nbs/5. Text to semantic token modeling μP.ipynb 38
...
# %% ../nbs/5. Text to semantic token modeling μP.ipynb 41
